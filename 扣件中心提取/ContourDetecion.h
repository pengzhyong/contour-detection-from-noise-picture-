...
public:
	...
	Mat GaborEnergy(Mat& srcImg, Mat& dirImg, vector<Mat >& vGaborE, double lamda1 = 3, double gama1 = 0.5, int size = 11, double sigmaRatio = 0.56);
	void FacilitationEnergy(vector<Mat >& vGaborE, vector<Mat >& faciEnergy, Mat& maxGabor, Mat& dirImg, int size = 11);
